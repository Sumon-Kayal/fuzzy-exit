...
Fuzzy Exit is not intended to modify native Windows shells. The installer detects Windows-compatible environments such as `MINGW*`, `MSYS*`, and `CYGWIN*`, and stops without modifying shell configuration. The message is intentionally simple:
